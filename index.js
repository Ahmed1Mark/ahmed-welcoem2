...
// تحديد الرابط من YouTube
const youtubeLink = 'https://www.youtube.com/playlist?list=PLKtToRbEOUgNHFWP2kh-sohk5KJ-0Myso';

// توليد مصدر الصوت من الرابط
const resource = createAudioResource(ytdl(youtubeLink, { filter: 'audioonly' }));

// إضافة المصدر إلى المشغل
player.play(resource);

// تجهيز معلومات الاتصال بالصوت
const channelId = '1158803629889822762';
const connection = joinVoiceChannel({
  channelId: channelId,
  guildId: '1089614823374991520',
...
// إظهار رسالة عند الانضمام إلى القناة الصوتية
